...
class GetAddress extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Text("${address.houseNo} , ${address.street} , ${address.landMark} , ${address.city} , ${address.state} , ${address.zipCode} , ${address.country}",style: textStyle ?? AppTextStyles.medium16P(),maxLines: null,);
  }
}
